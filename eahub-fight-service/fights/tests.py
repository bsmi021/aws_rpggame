...
if __name__ == "__main__":
    ...
    enemy = Enemy(id="1", can_block=True, can_dodge=True, block_pct=0.05,
                  block_amt=.54, dodge_pct=0.07, base_hp=35000, curr_hp=35000, prev_hp=35000)
    ...
    multiprocessing.Process(target=get_fight, args=(fight.id, )).start()
